...
.font150[La versión actual (*tidyverse 2.0.0*) incluye los paquetes: **ggplot2**, **dplyr**, **tidyr**, **readr**, **purrr**, **tibble**, **stringr**, **forcats** y **lubridate**.
...
.font150[
- Obtención de **estadísticos** (media, proporción, desvío estándar, tablas, etc.) uni y bivariados.

  - Código construido a partir de resumenes de tidyverse con funciones estadísticas (*summarise + funciones tipo mean, median, sd, etc*)
  
  - Funciones diseñadas para resumir conjuntos de variables de tablas de datos:
  
    - `skim()` de **_skimr_**, `describe()` de **_dlookr_**, `tabyl()` de **_janitor_** entre otras.

- **Gráficos**: funciones del paquete **_ggplot2_** (basado en gramática de gráficos)
]
---
### Detectar valores atípicos (outlier)
...
.font150[
- Gestión básica de datos con tidyverse
