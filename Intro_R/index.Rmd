...
```{r}
is.vector(respuesta) # preguntamos si sexo es un vector
is.factor(respuesta) # preguntamos si sexo es un factor
class(respuesta)  # visualizamos el tipo de dato de sexo
```
...
Vamos a crear un dataframe llamado `datos` con 4
...
como V para varón y M para mujer y la tercera TRABAJA de formato
