...
< AQUÍ VA LA PARTE TEORICA DE ESTUDIOS DE COHORTES Y POISSON >
...
Un criterio importante en la elección de la función de enlace para varias familias de distribuciones es asegurar que los valores ajustados del modelado permanezcan dentro de límites razonables. La especificación de un enlace logaritmico (predeterminado para Poisson) garantiza que los recuentos ajustados sean todos mayores o iguales a cero (propio de los conteos).
...
```
El ajuste continúa sigue bueno.
...
Virasakdi Chongsuvivatwong (2018). epiDisplay: Epidemiological Data Display Package. R
package version 3.5.0.1. https://CRAN.R-project.org/package=epiDisplay
