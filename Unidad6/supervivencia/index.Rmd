...
que puede interpretarse, aproximadamente, como la probabilidad de morir (en el caso que el evento sea muerte) en el intervalo ($t$, $t + \Delta t$], dado que se está vivo al tiempo $t$. Podemos interpretarla como una medida de intensidad de muerte al tiempo $t$, o una medida de
muerte potencial al tiempo $t$.
