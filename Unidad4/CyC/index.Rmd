...
En R, la forma de incluir y probar un término de interacción dentro de un modelo es mediante el uso del símbolo __\*__ en lugar del __+__. Esto provoca que se tengan en cuenta cada una de las variables individualmente y la interacción.
...
En el ámbito epidemiológico habitualmente se aplica una fórmula clásica propuesta por Freeman DH (1987), que en términos generales define que el tamaño de la muestra debe ser 10 veces el numero de variables independientes a estimar más uno.
