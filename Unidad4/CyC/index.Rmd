...
En R, el función `anova()` nos permite también la comparación:
...
Es similar al valor $t$ de la salida en las regresiones lineales y lo utilizamos para determinar la significación de la variable dentro del modelo. La interpretación es flexible y común a las situaciones conocidas, valores de $p$ por debajo de 0,5 (o 0,1 siendo tolerantes) permiten que tengamos en cuenta el aporte de dicha variable al modelo.
...
Por lo tanto podemos decir que nuestro modelo seleccionado transformado a fórmula es:
...
Luis Carlos Silva Aycaguer. Excursión a la regresión logística en ciencias de la salud. Ediciones Díaz de Santos, 1995.
