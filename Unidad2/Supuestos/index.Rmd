...
En el lenguaje R hay varios paquetes que tienen funciones para construirlos. Uno de los vistos previamente fue `` de **dlookr**. 

```{r, echo= F, message=F, warning=F}
datos <- read.csv2("datos_normalidad.csv")
```

```{r, fig.asp = 0.7, fig.width = 400/72, fig.height = 400/72, fig.align="center",message=F, warning=F}
library(tidyverse)
library(dlookr)
