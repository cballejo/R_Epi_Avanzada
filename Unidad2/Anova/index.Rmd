...
El archivo **_Anova-HDL.txt_** es de texto plano y utiliza el punto y coma (;) como separador.
...
```{r, message=F, warning=F, fig.align='center', fig.asp = 0.7, fig.width = 4, out.width="80%"}
HDL %>% 
  ggplot(aes(x = hdl)) + 
...
```{r, message=F, warning=F, fig.align='center', fig.asp = 1.2, fig.width = 3, out.width="60%"}
...
```{r, fig.align='center', fig.asp = 0.7, fig.width = 5}
HDL %>%
