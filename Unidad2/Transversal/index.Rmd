...
Utilizaremos la función `sample.size.prop()` del paquete *samplingbook* para estimar el tamaño de una muestra pensada para obtener una estimación de proporción con su IC fijando una precisión alta (0.01), la peor proporción esperada (0.5), un tamaño poblacional desconocido (Inf) y un nivel de confianza para los IC de 0.95. 
...
La misma función aplicada para un caso similar pero conociendo la población (por ejemplo de 50000 individuos):

```{r}
sample.size.prop(e = 0.01, P = 0.5, N = 50000, level = 0.95)
```
En este último caso, la función aplica la corrección de población finita.
