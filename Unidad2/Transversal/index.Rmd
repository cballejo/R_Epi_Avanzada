...
bebe2 <- read.csv2("bebe2.csv")

library(DataExplorer)

plot_qq(data = bebe1$peso, 
        title = "QQ-plot Peso Bebe1",
        geom_qq_args = list(color = "firebrick4") )

plot_qq(data = bebe2$peso, 
        title = "QQ-plot Peso Bebe2",
        geom_qq_args = list(color = "olivedrab") )
```
...
bebe1 <- read.csv2("Unidad2/Transversal/bebe1.csv")
bebe2 <- read.csv2("Unidad2/Transversal/bebe2.csv")
...
```{r}
enfermos <- read.csv2("enfermos.csv") # leemos los datos

mean(enfermos$V1)                     # calculamos la media
sd(enfermos$V1)                       # calculamos el desvío estandar
