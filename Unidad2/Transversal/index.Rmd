...
En R, lo podemos hacer con la función `z.test` del paquete **TeachingDemos** que trabaja con valores z de la distribución normal.
...
El p-valor de 0,01158 es significativo (< 0,05) por lo que rechazamos la hipótesis nula de que la presión media de los enfermos que toman el nuevo fármaco es igual a la presión promedio de los enfermos que no lo toman. Por lo tanto, concluimos que la media de presión arterial del grupo de pacientes tratados con el nuevo fármaco es significativamente menor respecto de los no tratados.
