...
```{r}
svyciprop(formula = ~I(agecat == "(0,19]"), 
          design = d)
svyciprop(formula = ~I(agecat == "(19,39]"), 
          design = d)
svyciprop(formula = ~I(agecat == "(39,59]"), 
          design = d)
svyciprop(formula = ~I(agecat == "(59,Inf]"), 
          design = d)
```
